...
var Vector = /*#__PURE__*/function () {
  ...
  _createClass(Vector, [{
    ...
    key: "distBetween",
    value: function distBetween(vec) {
      return Math.sqrt(Helper.sq(this.x - vec.x) + Helper.sq(this.y - vec.y) + Helper.sq(this.x - vec.x));
    }
  }, {
    key: "angelBetween",
    value: function angelBetween(vec) {}
  }]);

  return Vector;
}();

var Vector2D = /*#__PURE__*/function (_Vector) {
  ...
  function Vector2D(x, y) {
    ...
    return _super.call(this, x, y, 0);
  }

  return Vector2D;
}(Vector);

var v = new Vector(1, 0, 5);
var v2 = new Vector(0, 2, 4);
